...
export type RefDataUpdateEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  RefDataUpdateEventObject
>;
...
export interface PriceOracle extends BaseContract {
  ...
  functions: {
    ...
    refs(
      ...
      [BigNumber, BigNumber] & { rate: BigNumber; resolveTime: BigNumber }
    >;
  ...
  filters: {
    "RefDataUpdate(string,uint64,uint64)"(
      symbol?: null,
      rate?: null,
      resolveTime?: null
    ): RefDataUpdateEventFilter;
    RefDataUpdate(
      symbol?: null,
      rate?: null,
      resolveTime?: null
