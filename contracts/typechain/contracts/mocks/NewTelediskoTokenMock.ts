...
export interface NewTelediskoTokenMockInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "VestingSet2(address,address,uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "VestingSet2"): EventFragment;
}
...
export interface VestingSet2EventObject {
  from: string;
  to: string;
  amount: BigNumber;
}
export type VestingSet2Event = TypedEvent<
  [string, string, BigNumber],
  VestingSet2EventObject
>;

export type VestingSet2EventFilter = TypedEventFilter<VestingSet2Event>;

export interface NewTelediskoTokenMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NewTelediskoTokenMockInterface;
  ...
  filters: {
    ...
    "VestingSet2(address,address,uint256)"(
      from?: null,
      to?: null,
      amount?: null
    ): VestingSet2EventFilter;
    VestingSet2(from?: null, to?: null, amount?: null): VestingSet2EventFilter;
  };
